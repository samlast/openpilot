...
class CarControllerParams:
  ...
  SNG_DISTANCE = 170            # distance trigger value for stop and go (0-255)
  SNG_CANCEL_LIMIT = 70         # number of brake messages to cancel acc in hold
  SNG_RESUME_LIMIT = 5          # number of acc resume messages to send
